                ...
                <div className="footer-content">
                    ...
                    <div className="footer-col contact-col">
                        ...
                        <ul className="contact-list">
                            ...
                            <li>
                                <span className="icon">📞</span>
                                <a href="tel:+51945609129" style={{ color: 'inherit', textDecoration: 'none' }}>+51 945 609 129</a>
                            </li>
                            <li>
                        ...
                        <a
                            href="https://wa.me/51945609129?text=Hola,%20quisiera%20mas%20información"
                            target="_blank"
                    ...
                    <div className="footer-col social-col">
                        ...
                        <div className="social-icons">
                            ...
                            <a href="https://wa.me/51945609129?text=Hola,%20quisiera%20mas%20información" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
